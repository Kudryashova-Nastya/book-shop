        ...
        <>
            ...
            <ul className="nav nav-pills">
                <li className="nav-item sort">
                    ...
                    <button className='btn' onClick={Store.toggleSort}>
                        <svg className={Store.filters.sortPrice==="DESC" ? 'down' : 'up'} width="19" height="11" viewBox="0 0 19 11" xmlns="http://www.w3.org/2000/svg">
                            <path
